...
file in question is to be ignored. Thankfully git works even when its .git is
a symlink.

It is written to run on UNIX and UNIX-like OSes. If you want to port it to
...
** At present I don't consider this to be quite ready to call "done" yet.
   Needs more testing and attention.
